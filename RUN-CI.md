...
|---|---|
| **build** | Node 20, Python 3.12, Java 17, Firebase CLI · genera la configurazione · **cerca segreti nell'albero** · build · **doppia build deterministica** · coerenza dell'impronta nei quattro punti · **nessuna collisione fra nomi globali** · **backlog coerente con la matrice** · unit · integrazione · avvio · **regole Firestore su Emulator** |
...
| nomi globali | due moduli dichiarano lo stesso nome, e uno dei due perde il proprio valore in silenzio |
